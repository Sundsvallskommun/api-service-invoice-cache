...
class RequestValidatorTest {
    ...
    void testCheckInvoiceDates_fromIsAfterTo() {
        InvoiceFilterRequest request = new InvoiceFilterRequest();
    ...
    void testNoFieldIsSet() {
        assertThatExceptionOfType(ThrowableProblem.class).isThrownBy(() -> RequestValidator.validateRequest(new InvoiceFilterRequest()))
