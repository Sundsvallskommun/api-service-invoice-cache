...
END AS Filnamn
FROM
rdprodb4udp.udpb4_300.RK_FAKTA_KUNDFAKT AS kf -- Fetch specific information for a customer from "dimension table"
...
SELECT
    ...
    ORGNR
FROM
    rdprodb4udp.udpb4_300.RK_DIM_KUND -- If KUND_TAB_MOT is 860 it's a private person, we fetch everything though
