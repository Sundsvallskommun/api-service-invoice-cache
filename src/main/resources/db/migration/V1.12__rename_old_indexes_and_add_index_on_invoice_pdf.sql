...
create index idx_invoice_ocr_number on invoice (ocr_number);
create index idx_invoice_organization_number on invoice (organization_number);
create index idx_invoice_municipality_id on invoice (municipality_id);
...
create index idx_backupinvoice_invoice_number on backupinvoice (invoice_number);
...
create index idx_invoice_pdf_invoice_debtor_legal_id on invoice_pdf (invoice_debtor_legal_id);
create index idx_invoice_pdf_invoice_issuer_legal_id on invoice_pdf (invoice_issuer_legal_id);
create index idx_invoice_pdf_invoice_id on invoice_pdf (invoice_id);
create index idx_invoice_pdf_invoice_number on invoice_pdf (invoice_number);
create index idx_invoice_pdf_invoice_type on invoice_pdf (invoice_type);
create index idx_invoice_pdf_municipality_id on invoice_pdf (municipality_id);

-- Add new index on file_name in table "invoice_pdf"
create index idx_invoice_pdf_filename on invoice_pdf (filename);
